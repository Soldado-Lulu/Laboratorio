...
namespace Laboratorio.Logica
{
    public class QuimicaLogica
    {
        ...
        public bool Guardar(QuimicaM obj)
        {
            ...
            {
                conexion.Open();
                string query = @"INSERT INTO Quimica (Nombre, NombreM, Edad, Glucosa, Urea, Creatina, BUN, Urico, Colesterol, 
                         ...
                         VALUES (@nombre, @nombreM, @edad, @glucosa, @urea, @creatina, @bun, @urico, @colesterol, 
        ...
        public bool Editar(QuimicaM obj)
        {
            ...
            {
                conexion.Open();
                string query = @"UPDATE Quimica SET Nombre = @nombre, NombreM = @nombreM, Edad = @edad, Glucosa = @glucosa, 
